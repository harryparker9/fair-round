...
import { startAreaVoting, endRound, regressStage, updatePartyMember, castVote, finalizeVoting, deletePartyMember } from '@/actions/voting'
...

{
    isHost ? (
        ...
        <div className="p-3 bg-white/5 rounded-lg w-full">
            {generatingAreas ? (
                <div className="py-2"><LoadingNarrative active={true} /></div>
            ) : (
