...
export interface AreaOption {
    ...
    travel_times: Record<string, { to: number; home: number; summary?: string }> // member_id -> { to: mins, home: mins, summary: "Walk > Train" }
    ai_rationale?: string
    scoring?: {
        avg_time: number
        max_time: number
...
export interface PubRecommendation {
    ...
    travel_times: Record<string, { to: number; home: number; summary?: string }> // member_id -> { to: mins, home: mins }
